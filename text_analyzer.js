...
function findWasmBinary() {
  return locateFile('text_analyzer.wasm');
}
...
var _process_text = Module['_process_text'] = makeInvalidEarlyAccess('_process_text');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['process_text'] != 'undefined', 'missing Wasm export: process_text');
  _process_text = Module['_process_text'] = createExportWrapper('process_text', 1);
